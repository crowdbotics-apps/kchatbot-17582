"""kchatbot_17582 URL Configuration
...
admin.site.site_header = "KChatbot"
admin.site.site_title = "KChatbot Admin Portal"
admin.site.index_title = "KChatbot Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="KChatbot API",
        default_version="v1",
        description="API documentation for KChatbot App",
    ),
    public=True,
